...
public class IOSNativeSettingsEditor : Editor {
	...
	public static void UpdatePluginSettings() {
		...
		ChnageDefinetate(IOSNotificationController_Path, 		"PUSH_ENABLED", IOSNativeSettings.Instance.EnablePushNotificationsAPI);
		ChnageDefinetate(DeviceTokenListener_Path,		 		"PUSH_ENABLED", IOSNativeSettings.Instance.EnablePushNotificationsAPI);
		
		
		ChnageDefinetate(GameCenterManager_Path, 				"GAME_CENTER_ENABLED", IOSNativeSettings.Instance.EnableGameCenterAPI);
		ChnageDefinetate(GameCenter_TBM_Path, 					"GAME_CENTER_ENABLED", IOSNativeSettings.Instance.EnableGameCenterAPI);
		ChnageDefinetate(GameCenter_RTM_Path, 					"GAME_CENTER_ENABLED", IOSNativeSettings.Instance.EnableGameCenterAPI);
		
		ChnageDefinetate(IOSNativeMarketBridge_Path, 			"INAPP_API_ENABLED", IOSNativeSettings.Instance.EnableInAppsAPI);
		ChnageDefinetate(IOSStoreProductView_Path, 			"INAPP_API_ENABLED", IOSNativeSettings.Instance.EnableInAppsAPI);
		ChnageDefinetate(ISN_Security_Path, 					"INAPP_API_ENABLED", IOSNativeSettings.Instance.EnableInAppsAPI);
		
		
		
		ChnageDefinetate(iAdBannerControllerr_Path, 			"IAD_API", IOSNativeSettings.Instance.EnableiAdAPI);
		ChnageDefinetate(iAdBanner_Path, 						"IAD_API", IOSNativeSettings.Instance.EnableiAdAPI);
		
		ChnageDefinetate(IOSSocialManager_Path, 				"SOCIAL_API", IOSNativeSettings.Instance.EnableSocialSharingAPI);
		
		ChnageDefinetate(IOSCamera_Path, 						"CAMERA_API", IOSNativeSettings.Instance.EnableCameraAPI);
		
		ChnageDefinetate(IOSVideoManager_Path, 				"VIDEO_API", IOSNativeSettings.Instance.EnableMediaPlayerAPI);
		ChnageDefinetate(ISN_MediaController_Path, 			"VIDEO_API", IOSNativeSettings.Instance.EnableMediaPlayerAPI);
		
		ChnageDefinetate(ISN_ReplayKit, 						"REPLAY_KIT", IOSNativeSettings.Instance.EnableReplayKit);
	...
	private static void ChnageDefinetate(string file, string tag, bool IsEnabled) {
